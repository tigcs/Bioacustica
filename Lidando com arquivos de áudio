...
# Vizualizar arquivo de áudio em um oscilograma. O argumento "f" indica a frequência da taxa de amostragem do áudio em Hz, que não é obrigatório desde que o arquivo wave já tenha esta informação incorporada a ele.
...
a10 <- pastew(tico,tico,f=22050, output = "Wave")
````
